...
class Simulation:
    ...
    def run(self, generations, render=False):
        ...
        for gen in range(generations):
            ...
            print(" Best fitness ", round(best.fitness,2), 
                  " | average fitness ", round(self.stats['avg_fitness'][-1], 2))
...
def main():
    ...
    # saving run
    with open('result/' + env_name + '-evolutionary-run-' + str(seed) +'.plt', 'wb') as f:
        pickle.dump(sim, f)
